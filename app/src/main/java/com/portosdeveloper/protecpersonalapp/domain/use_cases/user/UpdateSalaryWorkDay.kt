...
class UpdateSalaryWorkDay@Inject constructor(private val repository: UsersRepository) {
    suspend operator fun invoke(user : User, newDate: String) = repository.updateSalaryWorkDay(user, newDate)
}