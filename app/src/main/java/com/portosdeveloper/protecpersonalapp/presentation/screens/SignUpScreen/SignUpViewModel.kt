...
import com.portosdeveloper.protecpersonalapp.presentation.screens.SignUpScreen.components.SignUpState
import com.portosdeveloper.protecpersonalapp.presentation.utils.ActualDate
import com.portosdeveloper.protecpersonalapp.presentation.utils.ComposeFileProvider
import com.portosdeveloper.protecpersonalapp.presentation.utils.ResultingActivityHandler
...
class SignUpViewModel @Inject constructor(
    ...
    //JOB TYPE
    var isJobValid by mutableStateOf(false)
        private set
    var jobErrMsg by mutableStateOf("Campo Obligatorio")
        private set
    val jobOptions = listOf("Corte","Fusionado","Cuerpos","CuellosPuños","Cerrado","Terminacion","OjalBoton","Empaque")
    ...
    fun onSignUp(){
        ...
        user.dateStart = actualDate.date
        user.actualDate = actualDate.date
    ...
    fun create() = viewModelScope.launch {
        user.id = "${state.name} ${state.surName}"
